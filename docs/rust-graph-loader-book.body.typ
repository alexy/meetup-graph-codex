= Preface
<preface>
This book teaches Rust through one concrete implementation: the By the
Bay graph loader. The loader takes meetup and conference data, turns it
into a portable graph model, and writes that graph to several database
backends: FalkorDB, HelixDB, and SurrealDB.
