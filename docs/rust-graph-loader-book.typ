...
#align(center)[
  ...
  #text(size: 10pt, fill: rgb("#64748b"))[
    Generated from the implementation in #raw("src/bin/load_graph.rs"), #raw("src/graph_loader.rs"), and #raw("scripts/enrich_meetup_entities.py")
  ]
...
#include "rust-graph-loader-book.body.typ"
